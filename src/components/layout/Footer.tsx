  ...
  return (
    <footer className="rule-double mt-24">
      <div className="mx-auto w-full max-w-7xl px-4 pt-10 sm:px-6">
        <p
          aria-hidden
          className="text-stroke select-none font-display text-[13.5vw] font-extrabold uppercase leading-none tracking-tight md:font-stretch-expanded md:text-8xl lg:text-9xl"
        >
          {SITE_NAME}
        </p>
      </div>
      ...
      <div className="border-t">
        <div className="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-2 px-4 py-4 font-mono text-xs text-muted-foreground sm:px-6">
